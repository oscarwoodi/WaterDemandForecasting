...
class ARIMAXModel:
    ...
    def train_model(self, arima_params, train, train_diurnal):
        ...
        for dma in self.dmas:
            ...
            model_arimax = ARIMA(train[dma]-train_diurnal[dma],
...
if __name__ == "__main__":
    ...
    arima_model.import_data(train_window=8*7, test_window=4*7, filepath_demand="../../data/InflowDataImputed.csv", filepath_weather="../../data/WeatherDataImputed.csv", filepath_diurnal="../../data/DiurnalDataImputed.csv")
    arima_model.roll_predict(4*7, 7)
    arima_model.save(filepath="../../results/ARIMA2_8W_+168H.csv")
