...
class SARIMAModel:
    """
    SARIMA model on demand with diurnal as exogenous variable and daily seasonality (boxcox). 
    """
    def __init__(self):
        self.model = None
    ...
    def import_data(self, train_window, filepath_demand, filepath_weather, filepath_diurnal):
        ...
        # applying transform
        self.inflow_df, self.lmdas = self.transform(self.inflow_df)
    ...
    def transform(self, df, lmdas=None, inverse=False): 
        """
        ...
        if not inverse: 
            ...
            lmdas = {dma: None for dma in df.columns}
        ...
        # inverse box-cox transform 
            ...
            for col in df.columns:
                x = df[col]
                boxcox_data = inv_boxcox(x, lmdas[col])
                transform_df[col] = boxcox_data
    ...
    def find_best_parameters(self):
        ...
        for dma in self.dmas: 
            ...
            arima_m = 24*7  # weekly seasonality
    ...
    def predict(self, models):
        ...
        # inverse transform
        self.results = self.transform(self.results, lmdas=self.lmdas, inverse=True)
...
if __name__ == "__main__":
    ...
    arima_model.save(filepath="../../results/SARIMA2_4W.csv")